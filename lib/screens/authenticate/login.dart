...
import 'package:taxc/screens/authenticate/forgotpassword.dart';
...
class _State extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text('Tax Calculator',textAlign: TextAlign.center,style: TextStyle(fontSize: 32,color: Colors.lightBlueAccent),),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                          decoration: InputDecoration(
                            ...
                            fillColor: Colors.lightBlueAccent[300],
                            filled: true,
